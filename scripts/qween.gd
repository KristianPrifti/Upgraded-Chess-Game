...
func get_possible_moves(position: Vector2, board, turn_player_isWhite):
	...
	while is_in_grid(Vector2(position.x + a, position.y)) && board[position.x + a][position.y] == null:
		moves_to_add.append(Vector2(a, 0))
		a += 1
	moves_to_add.append(Vector2(a, 0))
	# add moves to the left
	while is_in_grid(Vector2(position.x + b, position.y)) && board[position.x + b][position.y] == null:
		moves_to_add.append(Vector2(b, 0))
		b -= 1
	moves_to_add.append(Vector2(b, 0))
	# add moves up
	while is_in_grid(Vector2(position.x, position.y + c)) && board[position.x][position.y + c] == null:
		moves_to_add.append(Vector2(0, c))
		c += 1
	moves_to_add.append(Vector2(0, c))
	# add moves down
	while is_in_grid(Vector2(position.x, position.y + d)) && board[position.x][position.y + d] == null:
	...
	while is_in_grid(Vector2(position.x + e, position.y + e)) && board[position.x + e][position.y + e] == null:
		moves_to_add.append(Vector2(e, e))
		e += 1
	moves_to_add.append(Vector2(e, e))
	# add moves to the left and down
	while is_in_grid(Vector2(position.x + f, position.y + f)) && board[position.x + f][position.y + f] == null:
		moves_to_add.append(Vector2(f, f))
		f -= 1
	moves_to_add.append(Vector2(f, f))
	# add moves to the right and down
	while is_in_grid(Vector2(position.x + g, position.y + h)) && board[position.x + g][position.y + h] == null:
		moves_to_add.append(Vector2(g, h))
		g += 1
		h -= 1
	moves_to_add.append(Vector2(g, h))
	# add moves to the left and up
	while is_in_grid(Vector2(position.x + k, position.y + l)) && board[position.x + k][position.y + l] == null:
